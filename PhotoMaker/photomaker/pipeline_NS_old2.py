# photomaker/pipeline_NS_old2.py
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                # NEW 30 JUL
                # ───────────── build mask whenever we collect heat-maps ─────────────
                # (switch to branched mode only when it’s actually enabled)
                if collect_hm and i == branched_attn_start_step - 1:
