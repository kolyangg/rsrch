...
Usage:
    COMET_API_KEY=... python diffusion_template/comet_utils/export_comet_runs.py
    COMET_API_KEY=... python diffusion_template/comet_utils/export_comet_runs.py --step-number 500
...
DEFAULT_OUTPUT_DIR = SCRIPT_DIR.parent / "comet_data"
