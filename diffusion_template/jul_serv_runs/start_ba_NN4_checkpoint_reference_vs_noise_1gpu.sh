...
export RUN_NAME="${RUN_NAME:-ba_NN4_epoch${CHECKPOINT_EPOCH}_reference_vs_noise}"
export NN4_VALIDATION_MODEL="${NN4_VALIDATION_MODEL:-SG161222/RealVisXL_V4.0}"

OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/ppr_NN4_epoch${CHECKPOINT_EPOCH}_reference_vs_noise}"
