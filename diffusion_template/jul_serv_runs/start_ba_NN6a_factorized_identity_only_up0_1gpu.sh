...
# Primary-server NN6a: 4k approval run on cosmic_large_neb and RealVis validation.
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"

export NN1_CONFIG_NAME="one_id_ba_NN6a_factorized_identity_only_up0"
export NN1_RUN_NAME_DEFAULT="ba_NN6a_factorized_identity_only_up0_1gpu"
export NN1_DEFAULT_GPU="0"
export NN1_DEFAULT_PORT="29660"
export NN1_DESCRIPTION="NN6a: factorized clean identity-only residual at up_blocks.0"
