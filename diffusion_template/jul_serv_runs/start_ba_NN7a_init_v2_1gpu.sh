...
# Primary server: NN7a_init-v2 4k approval run; RealVis validation uses all 96.
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"

export NN1_CONFIG_NAME="one_id_ba_NN7a_init_v2"
export NN1_RUN_NAME_DEFAULT="ba_NN7a_init_v2_1gpu"
export NN1_DEFAULT_GPU="0"
export NN1_DEFAULT_PORT="29678"
export NN1_DESCRIPTION="NN7a_init-v2: complete sibling-attn2 warm space with visible pre-cap takeover"
