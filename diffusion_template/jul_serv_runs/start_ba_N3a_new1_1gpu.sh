...
export NN1_CONFIG_NAME="one_id_ba_N3a_new1"
export NN1_RUN_NAME_DEFAULT="ba_N3a_new1_1gpu"
export NN1_DEFAULT_GPU="0"
export NN1_DEFAULT_PORT="29681"
export NN1_DESCRIPTION="N3a_new1: up-only full-grid core-ring BA with PhotoMaker output anchor"
