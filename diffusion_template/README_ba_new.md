...
- [`src/model/photomaker_branched/attn_processor_clean.py`](src/model/photomaker_branched/attn_processor_clean.py) - core branched self-attention and cross-attention processors. It splits doubled batch into noise/ref halves, applies face/background masking, and merges with optional ID-feature mixing.
  ```python
