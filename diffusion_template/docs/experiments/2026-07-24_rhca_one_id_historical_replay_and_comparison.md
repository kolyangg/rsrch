...
diffusion_template/launchers/active/run_rhca_apr2026_one_id_1gpu.sh
diffusion_template/docs/experiments/2026-07-24_rhca_one_id_historical_replay_and_comparison.md
```
...
```bash
WRITER=console bash launchers/active/run_rhca_apr2026_one_id_1gpu.sh trainer.n_epochs=1 trainer.epoch_len=1
```
