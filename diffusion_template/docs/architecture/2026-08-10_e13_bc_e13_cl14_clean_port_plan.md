...
- `automatic_bboxes=true` with the historical run-specific derived generation
  bbox map; pin E13/BC_E13 to SHA-256 `4db6344d...` and CL14 to
  `b33cf026...`, while retaining the canonical manual Jensen override from
  `a39645e2...`; do not substitute or regenerate a similarly named map;
