...
def build_pipeline(
    ...
    *,
    ...
    # 3 Aug 2026 - Fixed-checkpoint evaluation must drive the installed hard-BA
    # processors with the same runtime extension flags used during training.
    for attribute in (
...
def run(args) -> None:
    ...
    intervention = {
        ...
        "spatial_ba_only": {
            ...
            "photomaker_identity_inputs_unchanged": True,
