"""Audited processor installation/prediction runtime for clean_full."""

import math
import torch
import torch.nn.functional as F

from .clean_full_attention_extension_config import (
    attention_extension_kwargs,
    resolve_attention_extensions,
)
...
def patch_unet_attention_processors(
    ...
    from .clean_full_attention_processor import (
    ...
    extension_enabled, extension_groups = resolve_attention_extensions(
        pipeline, hardcase_mode=hardcase_mode
    )
