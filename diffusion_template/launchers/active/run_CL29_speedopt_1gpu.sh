...
: "${RUN_NAME:?Set the unique CL29 speedopt run name}"
...
python tools/validate_CL29_speedopt_config.py \
...
"${FACE_QUALITY_SCORER_PYTHON}" tools/comet/finalize_deferred_face_quality.py \
  ...
  --expected-steps "2000,4000,6000,8000,10000,12000,14000,16000,18000,20000,22000,24000" \
