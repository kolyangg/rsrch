...
export SOURCE_RUN="rhca_cosmic_initial_selfref_4k_baseline_r2"
export SOURCE_TRAIN_COMET_KEY="aa982105aad148bf9b2a30d3fc2149f1"
export EVAL_RUN="${SOURCE_RUN}_full96_steps0_1k_2k_3k_4k"
export EVAL_COMET_KEY="658d22341cf24accb5a3890869e76c28"
...
export CONTINUATION_SPEC_PATH="${PROJECT_ROOT}/experiments/cosmic_large_continuation/rhca_cosmic_initial_selfref_baseline_r2_continue20k.json"
