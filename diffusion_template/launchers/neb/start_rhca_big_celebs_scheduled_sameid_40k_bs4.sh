...
export BIG_CELEBS_SAMPLING_PLAN="${BIG_CELEBS_POLICY_ROOT}/train_40k_bs4.jsonl"
export BIG_CELEBS_SAMPLING_PLAN_MANIFEST="${BIG_CELEBS_POLICY_ROOT}/train_40k_bs4_manifest.json"
export BIG_CELEBS_EXPECTED_SAMPLING_PLAN_SHA256="ff373204841cec5d06014faa7d3932442bfc256adf7fa02c63ca1e010ed2cbb8"
export BIG_CELEBS_MIN_FACE_RES=192
export BIG_CELEBS_SCHEDULE_START_STEP="${BIG_CELEBS_SCHEDULE_START_STEP:-0}"
export BIG_CELEBS_GLOBAL_BATCH_SIZE=4

export RUN_NAME="${RUN_NAME:-rhca_big_celebs_scheduled_v1_40k_bs4_full96_r1}"
...
exec bash launchers/active/run_rhca_big_celebs_scheduled_40k_bs4_1gpu.sh "$@"
