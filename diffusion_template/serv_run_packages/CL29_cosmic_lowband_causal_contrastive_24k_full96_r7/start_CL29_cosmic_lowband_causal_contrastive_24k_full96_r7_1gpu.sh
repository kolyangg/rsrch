...
RUN_ID="CL29_cosmic_lowband_causal_contrastive_24k_full96_r7"
CONDA_ENV="${OWNER_ROOT}/conda_env/photomaker_NS"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl29_fixed_v1/${RUN_ID}"
...
export CONFIG_NAME="CL29_cosmic_lowband_causal_contrastive_24k_fixed_pipeline"
