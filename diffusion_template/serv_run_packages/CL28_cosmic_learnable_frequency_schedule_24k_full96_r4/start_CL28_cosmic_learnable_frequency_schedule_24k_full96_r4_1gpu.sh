...
RUN_ID="CL28_cosmic_learnable_frequency_schedule_24k_full96_r4"
...
case "${RUN_ID}" in
  CL27_cosmic_frequency_surface_energy_24k_full96_r1)
    CONFIG_NAME="CL27_cosmic_frequency_surface_energy_24k" ;;
  CL27_cosmic_frequency_surface_energy_24k_full96_r2)
    CONFIG_NAME="CL27_cosmic_frequency_surface_energy_24k"; RUNTIME_SERIES="v3" ;;
  CL27_cosmic_frequency_surface_energy_24k_full96_r3)
    CONFIG_NAME="CL27_cosmic_frequency_surface_energy_24k"; RUNTIME_SERIES="v4" ;;
  CL28_cosmic_learnable_frequency_schedule_24k_full96_r1)
    CONFIG_NAME="CL28_cosmic_learnable_frequency_schedule_24k"; RUNTIME_SERIES="v1" ;;
  CL28_cosmic_learnable_frequency_schedule_24k_full96_r2)
    CONFIG_NAME="CL28_cosmic_learnable_frequency_schedule_24k"; RUNTIME_SERIES="v2" ;;
  CL28_cosmic_learnable_frequency_schedule_24k_full96_r3)
    CONFIG_NAME="CL28_cosmic_learnable_frequency_schedule_24k"; RUNTIME_SERIES="v3" ;;
  CL28_cosmic_learnable_frequency_schedule_24k_full96_r4)
    CONFIG_NAME="CL28_cosmic_learnable_frequency_schedule_24k"; RUNTIME_SERIES="v5" ;;
  CL29_cosmic_lowband_causal_contrastive_24k_full96_r1)
    CONFIG_NAME="CL29_cosmic_lowband_causal_contrastive_24k"; RUNTIME_SERIES="v1" ;;
  CL29_cosmic_lowband_causal_contrastive_24k_full96_r2)
    CONFIG_NAME="CL29_cosmic_lowband_causal_contrastive_24k"; RUNTIME_SERIES="v3" ;;
  CL29_cosmic_lowband_causal_contrastive_24k_full96_r3)
    CONFIG_NAME="CL29_cosmic_lowband_causal_contrastive_24k"; RUNTIME_SERIES="v5" ;;
  *) echo "Unknown CL27-CL29 run: ${RUN_ID}" >&2; exit 69 ;;
esac
RUNTIME_SERIES="${RUNTIME_SERIES:-v1}"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl27_cl29_${RUNTIME_SERIES}/${RUN_ID}"
...
exec bash launchers/active/run_CL27_CL29_cl23_followups_1gpu.sh
