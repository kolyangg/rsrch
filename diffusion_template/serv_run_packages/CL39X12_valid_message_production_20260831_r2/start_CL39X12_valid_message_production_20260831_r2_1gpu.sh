#!/usr/bin/env bash
# Sealed CL39X12 r2 recovery: cadence schema only; science unchanged.
set -euo pipefail

PACKAGE_ID="CL39X12_valid_message_production_20260831_r2"
OWNER_ROOT="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev"
SOURCE_PACKAGE="${OWNER_ROOT}/analysis_jobs/CL39X12_valid_message_20260831_r2/package"
SOURCE_ARCHIVE="${SOURCE_PACKAGE}/source_8effa14.tar.gz"
SOURCE_MANIFEST="${SOURCE_PACKAGE}/source_manifest.json"
SOURCE_SHA256="55b385464ed88b2072a90b24abd055558e777303114df9d926674546cde96094"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl39x12_valid_message_20260831_r2/${PACKAGE_ID}"
...
test "${PACKAGE_ID}" = CL39X12_valid_message_production_20260831_r2
test ! -e "${RUNTIME_ROOT}"
...
export RUN_NAME=CL39X12_cosmic_valid_kv_legacy_confidence_24k_full96_r2
