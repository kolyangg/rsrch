...
RUN_ID="CL39_cosmic_null_key_confidence_router_24k_full96_r3"
...
# 19 Aug 2026 - Sealed source snapshots live outside rsrch_test, while the
# fixed validation contract intentionally resolves ../dataset_full.
