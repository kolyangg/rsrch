...
RUN_ID="rhca_cosmic_full_canvas1024_posefirst_4k"
...
export EXPERIMENT_SPEC_PATH="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev/rsrch_test/diffusion_template/serv_run_packages/rhca_cosmic_full_canvas1024_posefirst_4k/${RUN_ID}.json"

case "${RUN_ID}" in
  rhca_cosmic_full_crop20_legacy_4k)
    export EXPERIMENT_ARM="crop20_legacy_4k"
    ;;
  rhca_cosmic_full_crop20_posefirst_4k)
