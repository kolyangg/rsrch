...
RUN_ID="ex_CL29_auxlookup_fix_speedcheck_r4"
CONDA_ENV="${OWNER_ROOT}/conda_env/photomaker_NS"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl29_speedopt_v4/${RUN_ID}"
...
exec bash launchers/active/run_CL29_speedcheck_1gpu.sh
