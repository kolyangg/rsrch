...
RUN_ID="rhca_cosmic_full_posefirst_speed_workers0_50"
...
export EXPERIMENT_SPEC_PATH="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev/rsrch_test/diffusion_template/serv_run_packages/rhca_cosmic_full_posefirst_speed_workers0_50/${RUN_ID}.json"
