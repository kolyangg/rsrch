...
class BranchedAttnProcessor(nn.Module):
    ...
    def _null_key_confidence(
        ...
        valid_count = None
        if self.valid_key_attention_enabled:
            valid_keys = ref_mask.squeeze(-1).bool()[:, None, :]
