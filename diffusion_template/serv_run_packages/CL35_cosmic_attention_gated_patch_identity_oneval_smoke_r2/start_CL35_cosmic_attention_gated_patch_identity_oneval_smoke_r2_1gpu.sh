...
RUN_ID="CL35_cosmic_attention_gated_patch_identity_oneval_smoke_r2"
...
if [[ "${RUN_ID}" == *_oneval_smoke_* ]]; then
  case "${RUN_ID}" in
    CL31_*) export CONFIG_NAME=CL31_cosmic_attention_ownership_alignment_oneval_smoke ;;
    CL35_*) export CONFIG_NAME=CL35_cosmic_attention_gated_patch_identity_oneval_smoke ;;
    CL36_*) export CONFIG_NAME=CL36_cosmic_ba_arcface_hinge_oneval_smoke ;;
  esac
fi
