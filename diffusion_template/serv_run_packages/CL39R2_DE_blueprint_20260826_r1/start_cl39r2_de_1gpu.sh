#!/usr/bin/env bash
# Sealed one-A100 launcher for blueprint E2/E3 training arms.
set -euo pipefail
...
case "${RUN_NAME}:${CONFIG_NAME}" in
  CL39R2D_cosmic_pm_target_condition_dropout_24k_full96_r1:CL39R2D_cosmic_pm_target_condition_dropout_24k) ;;
  CL39R2E_cosmic_valid_key_attention_24k_full96_r1:CL39R2E_cosmic_valid_key_attention_24k) ;;
  *)
...
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl39r2_de_v1/${RUN_NAME}"
