...
TASK_STATE="${TASK_OWNER_ROOT}/analysis_sidecars/cl9v_r2_submission_scheduler_20260810"
TASK_MLS="${TASK_OWNER_ROOT}/conda_env/photomaker_NS/bin/mls"
TASK_PYTHON="${TASK_OWNER_ROOT}/conda_env/photomaker_NS/bin/python"
TASK_SMALLFACE_YAML="${TASK_OWNER_ROOT}/rsrch_test/diffusion_template/serv_run_packages/cl9v_smallface_roi_20260810_r2/run_cl9v_smallface_roi_20260810_r2_1gpu.yaml"
TASK_MARION_YAML="${TASK_OWNER_ROOT}/rsrch_test/diffusion_template/serv_run_packages/cl9v_marion_occlusion_20260810_r2/run_cl9v_marion_occlusion_20260810_r2_1gpu.yaml"
TASK_GPU_CEILING=10
TASK_INTERVAL_SECONDS=1800
TASK_TARGET_LOCAL="2026-08-10T17:00:00"
