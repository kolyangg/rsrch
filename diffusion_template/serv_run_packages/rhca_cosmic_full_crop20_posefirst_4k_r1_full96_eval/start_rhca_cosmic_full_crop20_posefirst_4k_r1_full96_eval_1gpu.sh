...
RUN_ID="rhca_cosmic_full_crop20_posefirst_4k_r1_full96_eval"
...
export EXPERIMENT_SPEC_PATH="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev/rsrch_test/diffusion_template/serv_run_packages/rhca_cosmic_full_crop20_posefirst_4k_r1_full96_eval/${RUN_ID}.json"
