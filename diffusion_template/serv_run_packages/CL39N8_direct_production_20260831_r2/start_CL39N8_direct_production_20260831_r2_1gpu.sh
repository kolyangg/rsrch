#!/usr/bin/env bash
# Fresh sealed direct-production launch for N7-N9 after completed qualification.
set -euo pipefail

PACKAGE_ID="CL39N8_direct_production_20260831_r2"
OWNER_ROOT="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev"
SOURCE_PACKAGE="${OWNER_ROOT}/analysis_jobs/CL39N_direct_production_20260831_r2/package"
SOURCE_ARCHIVE="${SOURCE_PACKAGE}/source_8bb2fb1.tar.gz"
SOURCE_MANIFEST="${SOURCE_PACKAGE}/source_manifest.json"
SOURCE_SHA256="6d0d2926881b8be4479913b267fb999962d4c3d451d56234798ff0c1f485264d"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl39n_direct_production_20260831_r2/${PACKAGE_ID}"
...
case "${PACKAGE_ID}" in
  CL39N7_direct_production_20260831_r2)
    RUN_NAME=CL39N7_cosmic_posterior_null_router_24k_full96_r1
    CONFIG_NAME=CL39N7_cosmic_posterior_null_router_24k
    ;;
  CL39N8_direct_production_20260831_r2)
    RUN_NAME=CL39N8_cosmic_native_orthogonal_highband_24k_full96_r1
    CONFIG_NAME=CL39N8_cosmic_native_orthogonal_highband_24k
    ;;
  CL39N9_direct_production_20260831_r2)
    RUN_NAME=CL39N9_cosmic_intrinsic_id_sidecar_24k_full96_r1
    CONFIG_NAME=CL39N9_cosmic_intrinsic_id_sidecar_24k
    ;;
  *) echo "Unsealed CL39N production package: ${PACKAGE_ID}" >&2; exit 2 ;;
esac
