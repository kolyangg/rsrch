#!/usr/bin/env bash
# Sealed CL39N3S production; submit only after the sibling 101-step gate passes.
set -euo pipefail
...
RUN_NAME=CL39N3S_cosmic_arcface_hard_reference_softplus_24k_full96_r1
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl39n3s_softplus_20260831_r1/${RUN_NAME}"
...
RESUME_CHECKPOINT_SOURCE="${OWNER_ROOT}/runtime_sources_cl39_next_wave_r12/CL39N3R_cosmic_arcface_hard_reference_margin0275_24k_full96_r1/diffusion_template/saved/CL39N3R_cosmic_arcface_hard_reference_margin0275_24k_full96_r1/checkpoint-epoch1.pth"
...
test "$(sha256sum "${RESUME_CHECKPOINT_SOURCE}" | cut -d' ' -f1)" = \
...
export RUN_NAME CONFIG_NAME=CL39N3S_cosmic_arcface_hard_reference_softplus_24k_resume_epoch1
export RESUME_CHECKPOINT_SOURCE
