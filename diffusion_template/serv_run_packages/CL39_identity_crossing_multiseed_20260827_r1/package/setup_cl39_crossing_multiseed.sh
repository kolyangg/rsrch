#!/usr/bin/env bash
# Shared sealed environment for the CL39 seed-1/2/3 identity-source crossing.
set -euo pipefail
...
case "${EVAL_SEED}" in
  1|2|3) ;;
  *)
    echo "Refusing unreviewed validation seed: ${EVAL_SEED}" >&2
    exit 2
    ;;
esac

OWNER_ROOT="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev"
TASK_ROOT="${OWNER_ROOT}/analysis_jobs/CL39_identity_crossing_multiseed_20260827_r1"
SOURCE_DIR="source_seed${EVAL_SEED}"
...
export MPLCONFIGDIR="${TASK_ROOT}/runtime/seed_${EVAL_SEED}/matplotlib"
