#!/usr/bin/env bash
# Bounded diagnostic: prove each recovered CL39-CL44 arm crosses one optimizer step.
set -euo pipefail

OWNER_ROOT="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev"
SMOKE_RUN_ID="CL39_cosmic_null_key_confidence_router_24k_full96_r4_smoke1"
SOURCE_RUN_ID="${SMOKE_RUN_ID%_smoke1}"
