...
RUN_ID="CL14_CA"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl14_ca_v2/${RUN_ID}"
...
test -d "${PROJECT_ROOT}"
# 12 Aug 2026 - AICODE-NOTE: Verify the CL14-derived immutable source before
# loading credentials or starting CL14_CA.
