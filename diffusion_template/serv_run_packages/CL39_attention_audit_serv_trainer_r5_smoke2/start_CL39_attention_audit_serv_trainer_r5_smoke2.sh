...
TASK_NAME="CL39_attention_audit_serv_trainer_r5_smoke2"
...
root = Path("/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev/analysis_jobs/CL39_attention_audit_serv_trainer_r5_smoke2")
