...
RUN_ID="CL28_cosmic_learnable_frequency_schedule_24k_full96_r1"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl27_cl29_v1/${RUN_ID}"
...
case "${RUN_ID}" in
  ...
  CL28_cosmic_learnable_frequency_schedule_24k_full96_r1)
    CONFIG_NAME="CL28_cosmic_learnable_frequency_schedule_24k" ;;
  CL29_cosmic_lowband_causal_contrastive_24k_full96_r1)
    CONFIG_NAME="CL29_cosmic_lowband_causal_contrastive_24k" ;;
