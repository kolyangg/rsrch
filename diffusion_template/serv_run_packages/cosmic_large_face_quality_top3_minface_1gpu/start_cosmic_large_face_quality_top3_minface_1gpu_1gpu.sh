...
RUN_LOG_DIR="${OWNER_ROOT}/logs/cosmic_large_face_quality_top3_minface_1gpu"
STEPS="0,1000,2000,3000,4000,6000,8000,10000,12000,14000,16000,18000,20000"

case "cosmic_large_face_quality_top3_minface_1gpu" in
  ...
  cosmic_large_face_quality_top3_minface_1gpu)
    ...
    ;;
  *)
    echo "ERROR: unsupported package id: cosmic_large_face_quality_top3_minface_1gpu" >&2
    exit 64
    ;;
esac
...
echo "SERV_FACE_QUALITY_PAIR_COMPLETE package=cosmic_large_face_quality_top3_minface_1gpu"
