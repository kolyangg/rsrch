#!/usr/bin/env bash
# Sealed one-A100 launcher for CL39 INIT-R-NATIVE.
set -euo pipefail

RUN_NAME="CL39I_cosmic_reference_native_init_24k_full96_r1"
CONFIG_NAME="CL39I_cosmic_reference_native_init_24k"
OWNER_ROOT="/mnt/virtual_ai0001053-01309_SR006-nfs1/nasilaev"
CONDA_ENV="${OWNER_ROOT}/conda_env/photomaker_NS"
RUNTIME_ROOT="${OWNER_ROOT}/runtime_sources_cl39i_v1/${RUN_NAME}"
