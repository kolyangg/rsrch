...
: "${RUN_ID:=CL5_cosmic_joint_shadow_sa128_roiwarp_multiref_24k_full96_r1}"
...
case "${RUN_ID}" in
  CL0_cosmic_joint_shadow_sa128_asis_24k_full96_r1)
    CONFIG_NAME="CL0_cosmic_joint_shadow_sa128_asis_24k" ;;
