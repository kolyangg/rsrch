#!/usr/bin/env bash
# Overnight batch: N13 (IDENTITY LOSS, flagship) FIRST, then N10 -> N11 -> N12.
...
#   bash serv_new_runs/run_overnight_N13_N10_N11_N12.sh
#
# Results in saved/{ba_idloss_N13, ba_coadapt_N10, ba_saonly_N11, ba_idembeds_N12}. Score with
