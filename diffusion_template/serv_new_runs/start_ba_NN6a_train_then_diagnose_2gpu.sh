...
TRAIN_RUN_NAME="${TRAIN_RUN_NAME:-ba_NN6a_factorized_identity_only_up0_nfs_2gpu}"
export NN6_RUN_NAME="${TRAIN_RUN_NAME}"
export NUM_EPOCHS=2
export STEPS_PER_EPOCH=2000
bash "${SCRIPT_DIR}/start_ba_NN6a_factorized_identity_only_up0_2gpu.sh"
...
# The training processes have exited, so use GPU 0 for the deterministic 96-case test.
CHECKPOINT_EPOCH=2 \
