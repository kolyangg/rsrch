#!/usr/bin/env bash
# Overnight ablation matrix: runs N4 -> N5 -> N6 one after another.
# Design & rationale: debug_04Jul/overnight_N4_N6_plan.md  (results feed 04Jul_findings.md §9).
#
...
#   N4  3000 steps + 6 vals  ~= 3.5-4 h
#   N5  3000 steps + 3 vals  ~= 3-3.5 h
#   N6  3000 steps + 3 vals  ~= 3-3.5 h
#   -------------------------------------
#   total ~= 9.5-11 h   (fits an overnight; if a night is short, drop N6 or lower n_epochs)
#
...
#   bash serv_new_runs/run_overnight_N4_N5_N6.sh
#
# Results land in saved/ba_nr_alt_N4, saved/ba_nr_alt_N5, saved/ba_nr_blend_N6
...
EXPERIMENTS=(
    "start_ba_nr_alt_vast_N4.sh"
    "start_ba_nr_alt_vast_N5.sh"
    "start_ba_nr_blend_vast_N6.sh"
)
