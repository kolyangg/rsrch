...
# N32: richer hard-reference-face memory, 10k optimizer steps on one GPU.

RUN_NAME="ba_facepatch_resampler_N32"
...
echo "Validation: step0=24 images; full=96 at 2k,4k,6k,8k,10k; batch=12"
...
accelerate launch --config_file=src/configs/ddp/accelerate.yaml \
    ...
    --config-name=one_id_ba_facepatch_resampler_N32 \
