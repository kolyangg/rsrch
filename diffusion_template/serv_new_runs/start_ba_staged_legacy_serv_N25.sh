...
# N25: N17-style legacy BA with staged training matching the inference schedule; CA frozen.

RUN_NAME="ba_staged_legacy_N25"
...
accelerate launch --config_file=src/configs/ddp/accelerate.yaml \
    ...
    --config-name=one_id_ba_staged_legacy_N25 \
