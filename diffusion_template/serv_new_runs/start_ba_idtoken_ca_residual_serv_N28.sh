...
# N28: direct target-face ID-token CA residual; no spatial reference UNet branch.

RUN_NAME="ba_idtoken_ca_residual_N28"
...
accelerate launch --config_file=src/configs/ddp/accelerate.yaml \
    ...
    --config-name=one_id_ba_idtoken_ca_residual_N28 \
